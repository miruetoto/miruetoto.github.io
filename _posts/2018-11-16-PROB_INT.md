...
- **(듀렛책, Thm 1.7.1)** 두개의 확률변수 $X_1$과 $X_2$를 각각 $(\Omega_1,{\cal F}_ 1, P_1)$와 $(\Omega_2,{\cal F}_ 2, P_2)$에서 정의하자. 확률벡터 $(X_1,X_2)$를 정의하기 위한 공간을 construct하자. 먼저 
\begin{align}
...
\end{align}
듀렛책의 thm 1.7.1에 의하면 위와 같은 성질을 만족하는 메져 $P$ 가 ${\cal F}$에서 유니크하게 존재한다고 한다. 
