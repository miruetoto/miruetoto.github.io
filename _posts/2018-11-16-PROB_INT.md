...
- 위에서 $(\Omega_1,{\cal F}_ 1, P_1)$ 에서 $P_1$ 대신에 $\sigma$-finite measure $\mu_1$을 써서 만든 공간을 ***$\sigma$-finite measure space*** 라고 한다. 위의 정리는 유한개의 ***$\sigma$-finite measure space*** 에서 각각 정의된 measure $\mu_1,\mu_2,\dots,\mu_n$ 에 대한 ***product measure*** 가 공간 
\begin{align}
