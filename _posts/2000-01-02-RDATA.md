...
- make tibble with 3 columns. <br/><br/> 
```r
> tibble(x=x,y=y,z=z)
```
...
- make (temporary) matrix using *cbind()* <br/><br/>
```r
> cbind(x,y,z)
```
note that each column-name of this matrix is x,y and z, respectively. 

- convert temporary matrix to tibble. <br/><br/>
```r
