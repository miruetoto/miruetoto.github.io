...
- 티블에서 특정컬럼을 제외한 결과를 얻고 싶을때 사용한다. 
...
- 티블에서 특정문자열로 시작하는 컬럼만 선택하고 싶을때 사용한다. 
...
- 티블에서 특정문자열로 끝나는 컬럼만 선택하고 싶을때 사용한다. 
...
***select(...,everyting())***
- 티블에서 특정변수들을 선택하여 앞쪽 컬럼으로 이동시키고 싶을때 사용한다. 
