...
\end{align}
참고로 위와 같은 ball 들을 모은 collection 을 ${\cal B}$라고 하자. 그리고 ${\cal B}$의 임의의 원소를 언카운터블-유니온하여 얻을 수 있는 집합들의 모임을 ${\cal T}$라고 하자. 그러면 (1) ${\cal T}$ 가 $X$ 의 토폴로지임을 보이고 (2) ${\cal B}$의 모든 원소가 오픈셋임을 보인다면 ${\cal B}$는 ${\cal T}$의 base가 된다고 주장할 수 있다. 우선 (1) 을 보이자. ${\cal T}$가 언카운터블-유니온에 닫혀있음 associative laws에 의해서 성립하고  ${\cal T}$가 파이나이트-인터섹션에 닫혀있음은 distributive laws 에 의하여 성립한다. 이제 (2) 를 보이자. 
