...
- 여기에서 시간축에서 연속신호는 $x(t)$와 같이 정의하고 시간축에서 이산신호는 $x[n]$과 같이 정의한다. 그리고 주파수영역에서 연속신호는 $X(\omega)$와 같이 정의하고 주파수영역에서 이산신호는 $X[k]$와 같이 정의한다. 이때 $t$와 $\omega$의 도메인은 $\mathbb{R}$이며 $n$과 $k$의 도메인은 $\mathbb{Z}$이다. 
