...
**case 3: 주기-연속** <br/>
\begin{align}
\left\\{x(t): \int_{0}^{\zeta} |x(t)| dt <\infty,~ t \in \mathbb{R} \right\\}. 
\end{align}
**case 4: 주기-이산*** <br/>
\begin{align}
\left\\{x_i: \sum_{i=0}^{\xi-1} |x_i| <\infty,~ i \in \mathbb{Z} \right\\}. 
\end{align}
...
\left\\{x_i: \sum_{i=-\infty}^{\infty} |x_i| <\infty,~ i \in \mathbb{Z} \right\\}
\Longleftrightarrow 
\left\\{\hat x(\omega): \int_{0}^{2\pi} |\hat x(\omega)| d\omega <\infty,~ \omega \in \mathbb{R} \right\\}. 
\end{align}
**case 3: 주기-연속** <br/>
\begin{align}
\left\\{x(t): \int_{0}^{\zeta} |x(t)| dt <\infty,~ t \in \mathbb{R} \right\\}
...
**case 4: 주기-이산** <br/>
\begin{align}
\left\\{x_i: \sum_{i=0}^{\xi-1} |x_i| <\infty,~ i \in \mathbb{R} \right\\}
\Longleftrightarrow 
\left\\{\hat x_k: \sum_{k=0}^{\xi-1} |\hat x_k| <\infty,~ k \in \mathbb{Z} \right\\}. 
\end{align}
