...
---
## Data Transformation: dplyr, pandas
---
...
select(A,contains("Z"))
```
차이를 잘 모르겠다면 [여기](https://github.com/miruetoto/miruetoto.github.io/blob/master/my_code/DataAnal/datatransformation_ex6.ipynb)에 가서 결과를 구경하길.
