...
A.iloc[:,0]
```
예제는 [여기](https://github.com/miruetoto/miruetoto.github.io/blob/master/my_code/DataAnal/data_ex1.ipynb)를 참고해라. 이제부터 위에 제시된 4개의 방법의 장단점을 살펴보자. 
