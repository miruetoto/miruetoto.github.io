...
***mutate()***
- 기존의 컬럼들을 변화시켜 새로운 컬럼을 만들때 사용한다. 유용한데 처음 보면 딱히 인상적이진 않다. 아래와 같은 문법으로 사용한다. 우선 아래의 코드로 관심있는 변수를 선택한다. <br/><br/> 
```r
### r
...
```
선택된 변수는 year, month, day, dep_delay, arr_delay, distance air_time 이다. 
