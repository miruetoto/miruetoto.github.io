...
- 이 표현을 이해하는 것은 생각보다 쉽지 않다. 위의 기호중에서 가장 이해하기 쉬운것은 $(x_1,\dots,x_m)$이다. 이는 연속적인 실현치로 해석할 수 있는데 예를들면 아래와 같다. 
\begin{align}
x_1=\mbox{2020-03-20, 삼성전자의 주식값} 
\end{align}
\begin{align}
x_2=\mbox{2020-03-21, 삼성전자의 주식값} 
\end{align}
