...
<img src="https://www.groundai.com/media/arxiv_projects/330843/x1.png.750x0_q75_crop.png" width=200 />
...
\begin{align}
\begin{cases}
w^+ = w + \epsilon {w'}{\cal L}_ {train}(w,\alpha) \\
w^- = w - \epsilon {w'}{\cal L}_ {train}(w,\alpha)
\end{cases}
\end{align}
따라서 아래가 성립하게 된다. 
