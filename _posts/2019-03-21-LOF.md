...
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/LOF/fig1.png?raw=true" width="100%" height="100%"></center>
즉 $o \in C_1$ 이면 $LOF_k(o) \approx 1$이 성립하게끔 하는것우리가 정의한 LOF가 과연 이러한 성질을 만족할까? Lemma1은 $C_1$에 존재하는 모든 점들은 아웃라이어가 아니라는 결론을 주는(정말?? 좀 애매한데? ㅋㅋ) 레마이다. 
