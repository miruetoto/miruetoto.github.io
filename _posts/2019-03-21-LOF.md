---
layout: post 
title: (논문) LOF: identifying density-based local outliers
---
...
- 위의 논문에서는 RD라는 개념이 나오는데 이것이 우리가 제안하는 dissimilarity와 유사하다. 이 논문에서 제시한 anormally detection방법과 우리의 방법을 비교해보면 매우 유익할것이다. 
