...
- ACF 
	- corr: $\rho_0=1, \rho_1=0.8, \rho_2=0.8^2, \rho_3=0.8^3, \rho_4=0.8^4 \dots $ 
...
- PACF: $\phi_{11}=0.8, \phi_{22}=0, \dots $
...
- ACF: 
	...
	- cov: $\gamma_0=\frac{1}{1-0.8^2}, \gamma_1=\frac{0.8}{1-0.8^2},\gamma_2=\frac{0.8^2}{1-0.8^2},\dots $
