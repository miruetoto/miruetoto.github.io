...
- MA(2) 모형: 
\begin{align}
Z_t=\epsilon_t-\theta_1\epsilon_{t-1}-\theta_2\epsilon_{t-2}
\end{align}
아래와 같이 정리하면 
\begin{align}
\epsilon_t=\theta_1\epsilon_{t-1}+\theta_2\epsilon_{t-2}+Z_t
\end{align}
잠시 $Z_t\leftrightarrow \epsilon_t$ 와 같이 착각하면 
\begin{align}
Z_t^* =\theta_1\epsilon_{t-1}^* +\theta_2\epsilon_{t-2}^* 
\end{align}
