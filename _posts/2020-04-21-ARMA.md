...
(4) ACF
- corr: $\rho_1=1.3, \rho_2=0, \rho_3=0, 
- cov: $\gamma_0=1+0.49, \gamma_1=0.7\frac{1}{1+0.49}, 

(5) PACF: $\phi_{hh}=(-0.7)^h$. 

(6) correlogram: ACF는 lag=1에서만 존재함. PACF는 (부호가 교차하면서) 지수적으로 감소함. 
