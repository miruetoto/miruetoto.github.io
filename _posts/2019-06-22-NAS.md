...
**(4)** $r_{11}:=r\big(A_1=1,A_2=1\big):\quda$ 에이전트(=컨트롤러)가 $(\mbox{sigmoid},\mbox{sigmoid})$ 를 활성화함수로 선택했을때 보상.  <br/> <br/> 
...
\begin{align}
\mathbb{E}\big(R \big)&=r_{00}\frac{1}{1+e^c}\frac{1}{1+e^b}+r_{01}\frac{1}{1+e^c}\frac{e^{w+b}}{1+e^{w+b}} \\\\ \\
&+r_{10}\frac{e^c}{1+e^c}\frac{1}{1+e^b}+r_{11}\frac{e^c}{1+e^c}\frac{e^{w+b}}{1+e^{w+b}}
\end{align}
