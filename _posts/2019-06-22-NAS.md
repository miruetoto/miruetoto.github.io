...
- 아래는 $f(x)$를 구현한것이다. 
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/NAS/NASmyfig1.png?raw=true" width="100%" height="100%"></center>
...
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/NAS/NASmyfig2.png?raw=true" width="100%" height="100%"></center>
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/NAS/NASmyfig3.png?raw=true" width="100%" height="100%"></center>
...
\end{align}
를 계산하면 된다. 그런데 막상 미분하려고 보니까 좀 귀찮은거 같아서 코드로 구현하였다. 어차피 이해를 위해서는 미분텀의 closed form 이 필요한게 아니고 특정 $J_{\theta_c}$의 특정 좌표에서 편미분값들이 있는것이 더 좋으므로 이론적인 손미분은 미루도록 하자. 
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/NAS/NASmyfig4.png?raw=true" width="100%" height="100%"></center><br/>

- 이제 값들을 넣으면서 해석해보자. 아래는 global min 으로 잘 수렴한 예제이다. <br/><br/>
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/NAS/NASmyfig5.png?raw=true" width="100%" height="100%"></center> 

- 참고로 위에서 구해지는 해는 $\theta_c=(-8, 77, 77, 0, -16)$ 이고 $J_{\theta_c}$는 $0.0535$ 로 수렴하였다. 우리가 예상했던대로 <br/><br/>
**(1)** 큰 음수 값을 가지는 $c,b_2$ <br/>
**(2)** $w_2 \approx 0$ <br/>
**(3)** 어떤 값이든 상관없는 $w_1,b_1$ <br/>
**(4)** linear, linaer를 골랐을 경우의 손실함수 $J(\theta_c)=r_{00}=0.0535$ <br/>
들이 모두 적절하게 구해졌음을 알 수 있다. 

- 그런데 아래처럼 local min 으로 수렴할 수도 있다. 
...
- 이 경우 $J(\theta_c)=r_{11}=34.4771$에 가까운 상태에서 시작하여 $J(\theta_c)=r_{10}=0.3961$ 상태를 지났지만 $J(\theta_c)=r_{00}=0.0535$ 상태로는 가지 못하고 어떠한 지점에 갇힌것으로 해석된다. 
