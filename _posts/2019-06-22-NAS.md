...
**(1) $r_{00}$:**  $(a_1,a_2)=(0,0)=(\mbox{linear},\mbox{linear})$ 인 경우의 보상. <br/>
**(2) $r_{01}$:**  $(a_1,a_2)=(0,1)=(\mbox{linear},\mbox{sigmoid})$ 인 경우의 보상. <br/>
**(3) $r_{10}$:**  $(a_1,a_2)=(1,0)=(\mbox{sigmoid},\mbox{linear})$ 인 경우의 보상. <br/>
**(4) $r_{11}$:**  $(a_1,a_2)=(1,1)=(\mbox{sigmoid},\mbox{sigmoid})$ 인 경우의 보상. <br/> <br/> 
...
\begin{align}
\mathbb{E}\big(R \big) = \sum_{j=0}^{1}\sum_{i=0}^{1} r_{ij}~ \mathbb{P} ~ \big(A_2 = j ~ \big\| ~ A_1=i \big) \mathbb{P} \big(A_1 = i \big)
\end{align}
여기에서 $\mathbb{P} \big(A_1 = i \big)$ 와 $\mathbb{P} ~ \big(A_2 = j ~ \big\| ~ A_1=i \big)$는 아래와 같이 모델링 할 수 있다. 
\begin{align}
\begin{cases} 
\mathbb{P} \big(A_1 = i \big) = \frac{e^c}{1+e^c} \\\\ \\
\mathbb{P} ~ \big(A_2 = j ~ \big\| ~ A_1=i \big)=\frac{e^{wi+b}}{1+ e^{wi+b}}
\end{cases}
\end{align}
