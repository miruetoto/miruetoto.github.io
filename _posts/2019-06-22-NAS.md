...
\begin{align}
\mathbb{E}\big(R \big)=r_{11}p\frac{e^{wp+b}}{1+e^{wp+b}}+r_{12}p\frac{e^{w(1-p)+b}}{1+e^{w(1-p)+b}}+r_{21}(1-p)\frac{e^{wp+b}}{1+e^{wp+b}}+r_{22}(1-p)\frac{e^{w(1-p)b}}{1+e^{w(1-p)+b}}
\end{align}
