...
\begin{align}
\mathbb{E}\big(R \big) = \sum_{a_2 \in {\cal A}}\sum_{a_1 \in {\cal A}} r_{ij}~ \mathbb{P} ~ \big(A_2 = a_2 ~ \big\| ~ A_1=a_1 \big) \mathbb{P} \big(A_1 = a_1 \big)
\end{align}
여기에서 $\mathbb{P} \big(A_1 = a_1 \big)$ 와 $\mathbb{P} ~ \big(A_2 = a_2 ~ \big\| ~ A_1=a_2 \big)$는 아래와 같이 모델링 할 수 있다. 
\begin{align}
\begin{cases} 
\mathbb{P} \big(A_1 = 1 \big) = \frac{e^c}{1+e^c} \\\\ \\
\mathbb{P} ~ \big(A_2 = 1 ~ \big\| ~ A_1=a_1 \big)=\frac{e^{wa_1+b}}{1+ e^{wa_1+b}}
\end{cases}
\end{align}
