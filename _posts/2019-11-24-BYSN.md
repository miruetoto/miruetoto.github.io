...
|$X_1,\dots,X_n \| \mu, \sigma^2  \sim N(\mu,\sigma^2)$ | $\frac{\nu V(\mu\|\sigma^2)}{\sigma^2} \sim  \chi^2(\nu)$ <br/> $\mu \| \sigma^2 \sim N \Bigg(E(\mu\|\sigma^2), V(\mu\|\sigma^2)\big)$ | $\frac{\nu V(\mu\|\sigma^2)}{\sigma^2}\|x_1,\dots,x_n \sim  \chi^2(n+\nu)$ <br/> $\mu \| \sigma^2, x_1,\dots,x_n \sim N\Big(\frac{\sum x_i +\frac{\sigma^2E(\mu\|\sigma^2)}{V(\mu\|\sigma^2)}  }{n+\frac{\sigma^2}{V(\mu\|\sigma^2)} } , \frac{\sigma^2}{n+\frac{\sigma^2}{V(\mu\|\sigma^2)} }\Bigg)$ <br/> $\frac{\mu-\frac{\sum x_i +\frac{\sigma^2E(\mu\|\sigma^2)}{V(\mu\|\sigma^2)}  }{n+\frac{\sigma^2}{V(\mu\|\sigma^2)} } }{asd}$
<br/> 



$\kappa_0:=\frac{\sigma^2}{V(\mu\|\sigma^2)}$
