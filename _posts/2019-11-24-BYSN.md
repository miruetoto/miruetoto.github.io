...
|$X_1,\dots,X_n \|p \sim \mbox{Exp}(\lambda)$ where, $EX=\frac{1}{\lambda}$ | $\Lambda \sim \Gamma(\alphas,\beta)$ | $\Lambda\| x_1,\dots,x_n \sim \Gamma\big(n+\alpha,\big(\sum x_i+\frac{1}{\beta}\big)^{-1} \big)$ 
