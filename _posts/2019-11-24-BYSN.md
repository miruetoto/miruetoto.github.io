...
$\mu \| \sigma^2 \sim N \big(E(\mu\|\sigma^2), V(\mu\|\sigma^2)\big)$ | $\frac{\nu V(\mu\|\sigma^2)}{\sigma^2}\|x_1,\dots,x_n \sim  \chi^2(n+\nu)$ <br/> 
$\mu \| \sigma^2, x_1,\dots,x_n \sim N\Big(\frac{\sum x_i +\frac{\sigma^2E(\mu\|\sigma^2)}{V(\mu\|\sigma^2)}  }{n+\frac{\sigma^2}{V(\mu\|\sigma^2)} } , \frac{\sigma^2}{n+\frac{\sigma^2}{V(\mu\|\sigma^2)} }\Big)$ <br/> 
$\frac{\mu-E(\mu\|\sigma^2,x_1,\dots,x_n)}{\sigma^2} \big\| x_1,\dots,x_n \sim t(\nu+n)$
