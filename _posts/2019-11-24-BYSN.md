...
|$X_1,\dots,X_n \| \mu, \sigma^2  \sim N(\mu,\sigma^2)$     |      $\frac{\nu V(\mu\|\sigma^2)}{\sigma^2} \sim  \chi^2(\nu)$ <br/> $\mu \| \sigma^2 \sim N \big(E(\mu\|\sigma^2), V(\mu\|\sigma^2)\big)$     |     $\frac{\nu V(\mu\|\sigma^2)+(n-1)s^2}{\sigma^2}  + \frac{(n^{-1}+\kappa^{-1})^{-1}(\bar{x}+E(\mu\|\sigma^2))^2}{\sigma^2} \|x_1,\dots,x_n \sim  \chi^2(n+\nu)$ <br/> $\mu \| \sigma^2, x_1,\dots,x_n \sim N\Big(\frac{n\bar{x} +\kappa E(\mu\|\sigma^2)}{n+\kappa} , \frac{\sigma^2}{n+\kappa}\Big)$ <br/> $\frac{\mu-E(\mu\|\sigma^2,x_1,\dots,x_n)}{\sigma^2} \Bigg/ \Bigg)\frac{\nu V(\mu\|\sigma^2)+(n-1)s^2}{\sigma^2}  + \frac{(n^{-1}+\kappa^{-1})^{-1}(\bar{x}+E(\mu\|\sigma^2))^2}{\sigma^2}\Bigg)\Big/(n+\nu) \Bigg\| x_1,\dots,x_n \sim t(n+\nu)$
