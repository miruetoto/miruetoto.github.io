...
\begin{align}
\begin{cases}
\frac{\partial}{\partial \lambda_1} L(\lambda_1,\lambda_2,p ~\|~ {\bf Z}={\bf z},{\bf W}={\bf w})= 0 \\\
\frac{\partial}{\partial \lambda_2} L(\lambda_1,\lambda_2,p ~\|~ {\bf Z}={\bf z},{\bf W}={\bf w}) = 0 \\\
\frac{\partial}{\partial p} L(\lambda_1,\lambda_2,p ~\|~ {\bf Z}={\bf z},{\bf W}={\bf w}) =0 
\end{cases}
\end{align}
