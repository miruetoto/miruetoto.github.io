...
\begin{align}
\mathbb{E} {\boldsymbol\ell}^* = \mathbb{E} \bbig[ \sum_{i=1}^{n}W_i\|z_i \log \Big(\frac{pe^{-\lambda_1} \lambda_1^{z_i}}{z_i !} \Big) + (1-W_i\|z_i)\log \Big(\frac{(1-p)e^{-\lambda_2} \lambda_2^{z_i}}{z_i !}\Big) \bbig]
\end{align}
