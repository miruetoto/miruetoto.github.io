...
\begin{align}
L(\lambda_1,\lambda_2,p ~\|~ {\bf Z}={\bf z},{\bf W}={\bf w})=f({\bf z,w} ~\|~ \lambda_1,\lambda_2,p)=f({\bf w} ~\|~ p) f({\bf z} | {\bf w}; \lambda_1,\lambda_2)=\prod_{i=1}^{n}f(w_i~\|~ p)f(z_i|w_i; \lambda_1,\lambda_2)
\end{align}
