...
(3) ${\boldsymbol \beta}^{(n)} \leftarrow \big({\bf\tilde X'\tilde X }\big)^{-1}{\bf \tilde X' z} +\big({\bf\tilde X'\tilde X }\big)^{-1}{\bf \tilde X' (1 - p)}$
(4) ${\bf p}^{(n)} \leftarrow \frac{e^{\bf X \boldsymbol\beta} }{1+e^{\bf X \boldsymbol\beta} }$
