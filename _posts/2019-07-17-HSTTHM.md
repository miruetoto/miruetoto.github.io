...
\begin{align}
\boldsymbol{\dot h}(v_1),\dots \boldsymbol{\dot h}(v_n) ~ \sim ~ i.i.d. ~ F_{\boldsymbol{\eta}}
\end{align}
이다. 이때 $F_{\theta}:\mathbb{R} \to \mathbb{R}$ 이고 $F_{\boldsymbol{\eta}}: \mathbb{R}^{\tau} \to \mathbb{R}$ 임을 유의하라. 
