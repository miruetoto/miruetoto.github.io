...
박사학위 논문은 크게 두 개의 중심 논문으로 구성되어 있습니다. 첫번째는 비정형자료를 해석하는 통계적 방법을 연구했습니다. 여기에서 비정형자료란 비유클리드 자료를 의미하는데 벡터공간의 원소로 표현할 수 없는 자료를 통칭합니다. 매니폴드형 자료나 그래프 자료가 이러한 범주에 속합니다. 이러한 비정형자료를 분석하는 대표적인 방법은 임베딩기법과 스펙트럼분석이 있습니다. 
