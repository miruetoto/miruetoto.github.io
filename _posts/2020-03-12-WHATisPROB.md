...
- 이번강의에서는 확률을 정의하는 방법이 왜 어려운지 설명하겠다. 
...
<br/><br/>
즉 길이를 정의하기 힘든 집합은 제외하고 길이를 잴 수 있는 집합에 대해서만 확률을 정의하겠다는 의미이다. 여기에서 길이를 잴 수 있는 집합을 **measurable set**이라고 한다. 그리고 $\Omega$의 부분집합 중 길이를 잴 수 있는 집합들 적당히 모아놓은것을 $\Omega$의 $\sigma$-field라고 정의하고 기호로는 보통 ${\cal F}$와 같이 쓴다. 