...
\end{align}
보는 것처럼 ${\cal F}$의 원소는 집합이므로 ${\cal F}$는 집합들의 집합임을 기억하자. 다시한번 말하지만 ${\cal F}$의 모든 원소에 확률을 모순없이 정의할 수 있다. 

- 당연한 소리이지만 ${\cal F}$는 $\Omega$없이 혼자 정의될 수 없다. 이는 마치 남친의 정의와 비슷하다. ''나는 남친이에요''는 이상한 문장이지만 ''나는 XXX의 남친이에요''는 이상하지 않은 문장이다. 이처럼 ''${\cal F}$는 시그마필드에요''는 이상한 문장이고 ''${\cal F}$는 $\Omega$의 시그마필드에요''는 이상하지 않은 문장이다. 따라서 $\Omega$와 ${\cal F}$은 커플같은 것이라고도 생각할 수 있다. 그래서 이 둘을 묶어 $(\Omega,{\cal F})$라고 많이 표현한다. 
