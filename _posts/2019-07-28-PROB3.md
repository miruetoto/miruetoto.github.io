...
- 주의할점은 항상 $b_n=n$ 이며 $S_n=X_1+\dots+X_n$ 이지는 않다는 것이다. 가령 아래와 같은 것들의 수렴에 관심이 있을 수도 있다. 
\end{align}
S_1/b_1=X_1, S_3/b_3=\frac{X_1+2 X_2+X_3}{1+2+1}, S_5/b_5=\frac{X_1+2X_2+3X_3+2X_4+X_5}{1+2+3+2+1}, \dots 
\end{align}
이러한 수열을 표현하기에 적절한 방법이 바로 삼각수열 $X_{n,1},\dots,X_{n,n}$ 이다. 따라서 통상적으로 $S_n$은 아래와 같이 정의하는 것이 맞다. 
\begin{align}
