...
\end{align}
여기에서 $\frac{\mu_{w_{n,1}X_1} (\sum_{k=1}^n w_{n,k}):=E \big( w_ {n,1} X_1 1_ {\|w_{n,1}X_1\| \leq \sum_{k=1}^n w_{n,k} }\big)$ 우리가 흔히 아는 **WLLN** 의 경우 $w_{n,1},\dots,w_{n,n}=1$ 인 경우이다. <br/>
