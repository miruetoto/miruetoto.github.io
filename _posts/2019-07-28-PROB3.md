...
- 즉 ***Thm 2.2.6*** 과 ***Thm 2.2.7*** 는 확률변수의 $\frac{S_n}{b_n}$ 이 수렴하는 조건을 설명할 뿐이지 기대값으로 수렴하는 조건을 설명하는것은 아니란 것이다(수렴한다고 했지 그것이 꼭 기대값으로 수렴한다고는 하지 않았음). 기대값으로 수렴함을 증명한것은 ***Thm 2.2.9*** 이다. 
