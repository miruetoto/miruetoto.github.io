...
\begin{align}
P & (|S_n / n -\mu \| > \epsilon) \leq P(\|S_n/n -\mu \|+\|\mu(n)-\mu \| > \epsilon)  \\\\ \\
...
\begin{align}
& \mbox{family of measures } \\{\mu_i, i \in I\\} \mbox{ is } tight \\\\ \\
...
\begin{align}
\mbox{for all } \epsilon>0 \mbox{ there is an } M_{\epsilon} \mbox{ such that } \underset{n \to \infty}{\operatorname{limsup} } 1- F_n(M_{\epsilon})+F_n(-M_{\epsilon}) \leq \epsilon.
\end{align}
