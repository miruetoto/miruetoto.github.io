...
\begin{align}
\frac{\partial J}{\partial \bf W_3}=0 \Longleftrightarrow {\bf \hat W_2}=\big( {\bf \tilde X_2}'{\bf \tilde X_2}\big)^{-1}{\bf \tilde X_2}' {\bf y}
\end{align}
\begin{align}
\frac{\partial J}{\partial \bf W_3}=0 \Longleftrightarrow {\bf \hat W_1}=\big( {\bf \tilde X_1}'{\bf \tilde X_1}\big)^{-1}{\bf \tilde X_1}' {\bf y}
\end{align}
