...
- 그런데 지금 이거 대입하는게 중요한게 아니고 아래를 관찰하는게 더 중요하다. 
\begin{align}
\frac{\partial J}{\partial {\bf \tilde X_2'} }=\frac{\partial J}{\partial {\bf \tilde X_3'} }\frac{\partial {\bf \tilde X_3'}}{\partial {\bf \tilde X_2'} }
\end{align}
