...
\begin{align}
{\bf y} = g\(f({\bf X} {\bf W_1}){\bf W_2} \big){\bf W_3} + {\boldsymbol \epsilon}
\end{align} 
...
\begin{align}
{\bf y} = g\big(f({\bf X} {\bf W_1}+{\bf b_1} ){\bf W_2}+{\bf b_2} \big){\bf W_3} + {\bf b_3} + {\boldsymbol \epsilon}
\end{align} 
우리의 목적은 $J=({\bf y}-{\bf\hat y}\big)'\big({\bf y}-{\bf\hat y})$을 최소화하는 적당한 $\bf b_1, b_2, b_3, W_1, W_2, W_3$을 찾는 것이다. 여기에서 $J$는 스칼라이다. 앞에다가 $\bf 1$을 넣으면 바이어스 텀을 생략할 수 있다.따라서 아래를 연립해서 풀면된다. 
\begin{align}
\begin{cases}
...
\end{align}
이제 하나씩 풀어보자. 
$J={\boldsymbol\epsilon}'{\boldsymbol\epsilon}=\big({\bf y}-g(f({\bf X} {\bf W_1}){\bf W_2}){\bf W_3}\big)'\big({\bf y}-g(f({\bf X} {\bf W_1}){\bf W_2}){\bf W_3}\big)$으로 표현가능하다. 먼저 $\frac{\partial J}{\partial \bf W_3}=0$을 계산하면 아래와 같이 된다. 
\begin{align}
\big(g(f({\bf X} {\bf W_1}+{\bf b_1}){\bf W_2} +{\bf b_2})+{\bf b_3}\big)'\big(g(f({\bf X} {\bf W_1}+{\bf b_1}){\bf W_2} +{\bf b_2}){\bf W_3}+{\bf b_3}\big) = \big(g(f({\bf X} {\bf W_1}+{\bf b_1}){\bf W_2}+{\bf b_2} )+{\bf b_3}\big)'{\bf y} 
\end{align}
따라서 
\begin{align}
{\bf \hat W_3}=\big( g(f({\bf X} {\bf W_1}+{\bf b_1}){\bf W_2}+{\bf b_2})+{\bf b_3}\big)'\big(g(f({\bf X} {\bf W_1}+{\bf b_1){\bf W_2}+{\bf b_2} )+{\bf b_3} \big)^{-1}\big(g(f({\bf X} {\bf W_1}+{\bf b_1}){\bf W_2} +{\bf b_2})+{\bf b_3}\big)' {\bf y}
\end{align}
이다. 
