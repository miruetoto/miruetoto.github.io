...
**(1)** ${\bf x}_ i \quad : 1\times p$ row-vector <br/>
**(2)** ${\bf W_1}  \quad : $p\times p_1$ matrix <br/>
**(3)** $f:\mathbb{R}^{1 \times p_1} \rightarrow \mathbb{R}^{1 \times p_1}$ 인 vector function <br/>
**(4)** ${\bf W}_ 2$: $p_1 \times p_2 $ matrix <br/>
**(5)** $g:\mathbb{R}^{1 \times p_2} \rightarrow \mathbb{R}^{1 \times p_2}$ 인 vector function <br/>
**(6)** ${\bf W}_ 3$: $p_2\times p_3$ matrix <br/>
**(7)** ${\bf y}_ i$ 와 ${\boldsymbol\epsilon}_ i$ 은 $p_3 \times 1$ row-vector <br/><br/>
