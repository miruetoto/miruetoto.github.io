...
- 이제 하나씩 풀어보자. 
\begin{align}
J={\boldsymbol\epsilon}'{\boldsymbol\epsilon}=\big({\bf y}-f_2(f_1({\bf X} {\bf W_1}){\bf W_2}){\bf W_3}\big)'\big({\bf y}-g(f({\bf X} {\bf W_1}){\bf W_2}){\bf W_3}\big)
...
\end{align}
이다. 그리고 이를 이용하면 다시 $\frac{\partial J}{\partial \bf W_3}$를 아래와 같이 쓸 수 있다. 
\begin{align}
\frac{\partial J}{\partial \bf W_3}=2{\bf \tilde X_3'}({\bf \hat y}-{\bf y}).
\end{align}
...
\begin{align}
\frac{\partial {\bf \tilde X_3'}}{\partial {\bf W_2} }
=\frac{\partial f_2({\bf \tilde X_2}{\bf W_2}) }{\partial {\bf W_2} } 
=\frac{\partial f_2({\bf \tilde X_2}{\bf W_2}) }{\partial {\bf \tilde X_2}{\bf W_2}} \frac{\partial {\bf \tilde X_2}{\bf W_2} }{\partial {\bf W_2} } = f_2'({\bf \tilde X_2}{\bf W_2}){\bf \tilde X_2'}
\end{align}
따라서 아래와 같이 정리된다. 
\begin{align}
\frac{\partial J}{\partial \bf W_2}=\big({\bf \hat y}-{\bf y})'{\bf W_3}f'({\bf \tilde X_2}{\bf W_2}){\bf \tilde X_2'}
\end{align}
