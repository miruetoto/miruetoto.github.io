...
\begin{align}
\frac{\partial J}{\partial {\bf \tilde X_2'} }=\frac{\partial J}{\partial {\bf \tilde X_3'} }\frac{\partial {\bf \tilde X_3'}}{\partial {\bf \tilde X_2'} }= 2({\bf \hat y -{\bf y})'{\bf W_3}\dot{f}_ 2({\bf W_2'}{\bf \tilde X_2'}{\bf W_2}
\end{align}
여기에서 $\dot{f}_ 2({\bf W_2'}{\bf \tilde X_2'}$의 값은 3층의 정보를 바탕으로 역추적 할 수 있다. 또한 ${\bf W_2}$ 
