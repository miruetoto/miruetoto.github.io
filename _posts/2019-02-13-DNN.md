...
**(2)** 로지스틱함수:  $f~ \big(({\bf X T})_ {ij}\big)=\frac{e^{({\bf X T})_ {ij}}}{1+e^{({\bf X T})_ {ij}}}$ <br/> 
**(3)** 소프트맥스함수:  $f ~ \big({\bf x}_ i {\bf T}\big) = \frac{\exp({\bf x}_ i {\bf T})}{\exp({\bf x}_ i {\bf T}){\bf 1}}$ <br/> 
