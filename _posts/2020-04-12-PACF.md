...
분자를 정리하면 
\begin{align}
cov(Z_{t}^* ,Z_{t-2}^* )=cov(Z_t,Z_{t-2})-\frac{cov(Z_{t-2},Z_{t-1})}{V(Z_{t-1})}cov(Z_t,Z_{t-1})-\frac{cov(Z_{t},Z_{t-1})}{V(Z_{t-1})}cov(Z_{t-1},Z_{t-2})+\left[\frac{cov(Z_{t},Z_{t-1})}{V(Z_{t-1})}\right]\left[\frac{cov(Z_{t-2},Z_{t-1})}{V(Z_{t-1})}\right]cov(Z_{t-1},Z_{t-2})
\end{align}
