...
m(x)=&m(a)+(x-a)m^{(1)}(a) + O\big(x-a\big)^2=m(a)+O\big(x-a\big)+O\big((x-a)^2\big) \\\\ \\
...
\begin{align}
m(x)=&m(a)+O\big(x-a\big) \\\\ \\
m(x)=&m(a)+O\big(x-a\big)+O\big((x-a)^2\big) \\\\ \\
m(x)=&m(a)+O\big(x-a\big)+O\big((x-a)^2\big)+O\big((x-a)^3\big) \\\\ \\
\dots
\end{align}
