...
이므로 
\begin{align}
nA^2=n\bigg(\frac{t^2}{2n}\bigg)^2+2n\bigg(\frac{t^2}{2n}\bigg)O(n^{-3/2})+\bigg(O(n^{-3/2})\bigg)^2
\end{align}
이 되고 따라서 명백하게 $nA^2 \to 0 \quad as n \to \infty$ 이다. 
...
그런데 
\begin{align}
A=\frac{t^2}{2n}+O\bigg(\frac{t^3}{n\sqrt{n} }\bigg) = O\bigg(\frac{t^2}{n}\bigg)+\frac{t^2}{2n}+O\bigg(\frac{t^3}{n\sqrt{n} }\bigg)=O\bigg(\frac{t^2}{n}\bigg), \quad as \frac{t}{\sqrt{n} }\to 0 
\end{align}
