...
\begin{align}
(x-0) =& O\big(x-0\big), \quad as ~ x \to 0 \\\\ \\
\frac{(x-0)^2}{2!} =& O\big((x-0)^2\big), \quad as ~ x \to 0  \\\\ \\
\frac{(x-0)^3}{3!} =& O\big((x-0)^3\big), \quad as ~ x \to 0 \\\\
\dots
\end{align}
...
m(x)=&m(a)+(x-a)m^{(1)}(a) + O\big((x-a)^2\big)=m(a)+O\big(x-a\big)+O\big((x-a)^2\big) \quad as ~ x \to a \\\\ \\
m(x)=&m(a)+(x-a)m^{(1)}(a)+\frac{(x-a)^2}{2!}m^{(2)}(a)+O\big(x-a\big)^3=m(a)+O\big(x-a\big)+O\big((x-a)^2\big)+O\big((x-a)^3\big) \quad as ~ x \to a \\\\ \\
\dots
\end{align}
