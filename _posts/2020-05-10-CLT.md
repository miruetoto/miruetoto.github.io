...
\begin{align}
m(x)=1+xE\bigg(\frac{X_1-\mu}{\sigma}\bigg)+\frac{x^2}{2}E\bigg(\frac{X_1-\mu}{\sigma}\bigg)^2+R(x),\quad \frac{R(x)}{x^2} \underset{x \to \infty}{\to} 0 
\end{align}
그런데 $E\big(\frac{X_1-\mu}{\sigma}\big)=0$이고 $E\big(\frac{X_1-\mu}{\sigma}\big)^2=1$이므로 
\begin{align}
m(x)=1+\frac{x^2}{2}+R(x),\quad \frac{R(x)}{x^2} \underset{x \to \infty}{\to} 0 
\end{align}
$x$대신에 $t/\sqrt{n}$을 대입하면 
\begin{align}
m(t/\sqrt{n})=1+\frac{t^2}{2n}+R(t/\sqrt{n}),\quad \frac{R(x)}{x^2} \underset{x \to \infty}{\to} 0 
\end{align}