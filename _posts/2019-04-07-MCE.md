...
\end{align}
여기에서 $\delta(\epsilon):=\frac{1}{2}\underset{\theta \in {\cal C}-{\cal B}}{\operatorname{inf}} D_0(\theta) - D_0(\theta_0)$으로 정의하자. 처음에 우리가 $\left|\theta_n-\theta_0\right|>\epsilon$을 가정하였으므로 아래와 같이 주장할 수 있다. 
\begin{align}
