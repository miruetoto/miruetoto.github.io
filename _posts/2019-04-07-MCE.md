...
\end{align}
**(3)** $D_0(\theta)$는 *compact set* ${\cal C}$에서 연속이다. 
**(4)** $\underset{\theta}{\operatorname{sup}} D_0(\theta) < \infty$이다. 혹은 최소한 $\underset{\theta\in {\cal C}}{\operatorname{sup}} D_0(\theta) < \infty$
