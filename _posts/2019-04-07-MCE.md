...
\end{align}
여기에서 두번째 부등호가 성립함을 좀 더 자세히 살펴보자. $\theta \in {\cal C}-{\cal B}$에서 아래식이 (당연히) 성립한다. 
\begin{align}
...
그리고 아래식이 성립한다. 
\begin{align}
\underset{\theta \in {\cal C}-{\cal B}}{\operatorname{sup}} \left( D_0(\theta) - D_n(\theta) \right) + \underset{\theta \in {\cal C}-{\cal B}}{\operatorname{sup}}  D_n(\theta) 
\leq \underset{\theta \in {\cal C}-{\cal B}}{\operatorname{sup}} \left| D_0(\theta) - D_n(\theta) \right| + \underset{\theta \in {\cal C}-{\cal B}}{\operatorname{sup}}  D_n(\theta) 
\end{align}
...
따라서 아래식도 성립한다. 
\begin{align}
\underset{\theta \in {\cal C}-{\cal B}}{\operatorname{inf}} D_0(\theta) \leq \Delta_n + \underset{\theta \in {\cal C}-{\cal B}}{\operatorname{inf}} D_n(
\theta)
\end{align}
