...
**(i)** $(X,d_1) \overset{\mbox{isometric}}{\sim} (X,d_1)$, <br/>
**(ii)** $(X,d_1) \overset{\mbox{isometric}}{\sim} (Y,d_2)$ implies $(Y,d_2) \overset{\mbox{isometric}}{\sim} (X,d_1)$, <br>
**(iii)*** $(X,d_1) \overset{\mbox{isometric}}{\sim} (Y,d_2)$ and $(Y,d_2) \overset{\mbox{isometric}}{\sim} (Z,d_3)$ imply $(X,d_1) \overset{\mbox{isometric}}{\sim} (Z,d_3)$ <br/>
이다. 
...
- ***convergence*** 는 위상공간 $(X,{\cal T})$에서 정의되는 개념이다. 하지만 ***Cauchy sequency*** 는 메트릭스페이스 $(X,d)$에서 정의되는 개념이다.  
