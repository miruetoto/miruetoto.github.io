...
\begin{align}
\\{a_n\\} \mbox{ converges on } X \quad \Longleftrightarrow \quad \\{a_b\\} \mbox { is Cauchy sequence on $X$ and } \lim_{n\to\infty} a_n \in X
\end{align}
...
\end{align}
이라고 표현하자. 이때 관계 $\overset{slim}{\sim}$ 은 $X$에서 정의가능한 모든 코시수열들의 집합 ${\cal C}[X]$ 에서 ***equivalence relation*** 이 된다고 한다.  
