...
\end{align}
여기에서 ${\boldsymbol \Psi}=[{\boldsymbol p}_ 1 ,\dots,{\boldsymbol p}_ n]$이고 ${\bf \Lambda}=diag(\lambda_1,\dots,\lambda_n)$이다. 그리고 ${\bf A}={\boldsymbol \Psi}{\bf \Lambda}{\bf P}'$를 그대로 풀면 아래와 같이 쓸 수 있다. 
\begin{align}
