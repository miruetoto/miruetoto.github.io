...
특히 
\begin{align}
{\bf A}={\bf Q}{\bf \Lambda}{\bf Q}'=\sum_{i=1}^{n} \lambda_i Q_i Q_i'
\end{align}
와 같은 표현이나 
\begin{align}
{\bf A}{\bf Q}={\bf Q}{\bf \Lambda}
\end{align}
와 같은 표현은 자주나오므로 익숙해지는 것이 좋다. 또한 위의 과정에서 아래와 같이 매트릭스 계산하는 방식도 눈여겨볼만 하다. <br/>
**(1)** $cbind(\lambda_1 Q_1, \dots, \lambda_n Q_n) = cbind(Q_1, \dots, Q_n)diag(\lambda_1,\dots,\lambda_n)$. <br/>
**(2)** $cbind(\lambda_1 Q_1, \dots, \lambda_n Q_n) rbind(Q_1', \dots, Q_n')=\sum_{i=1}^{n} \lambda_i Q_i Q_i'$. 
