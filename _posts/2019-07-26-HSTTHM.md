...
아래가 성립할것 같다. 
\begin{align}
{\bf Lf}(v_i) \superset{pr}{\longrightarrow} {\cal L}_ {\cal M}f(v_i):=\frac{1}{\mbox{something} }\int_{\cal M} e^{ -\frac{d_1^2(v_i,v)}{2b^2} } \big(f(v_i)-f(v)\big)dP_{\cal M}(v)\quad \mbox{as } \|{\cal N}_ i \| \to \infty.  
\end{align}
