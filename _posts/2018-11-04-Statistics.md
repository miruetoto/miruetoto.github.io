...
- 좀 더 일반적으로 $V({\bf \epsilon}={\bf \Sigma}$인 경우를 살펴보아도 $\bf y=X\beta + \epsilon$의 양변에 ${\bf \Sigma}^{-\frac{1}{2}}$를 곱해주면 문제가 간단하다. 문제는 ${\bf \Sigma}^{-\frac{1}{2}}$이 존재하느냐는 것인데 이것은 잘 생각해보면 존재한다는 것을 쉽게 알 수 있다.  
