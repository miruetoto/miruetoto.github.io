...
\end{align}
이때 ${\bf y}$ 대신에 $(I-H_1){\bf y}$를 대입하면 첫번째 방법으로 구한 $\tilde{\beta_2}$가 되는데 $(I-H_1)^2=(I-H_1)$이 성립하므로 **언급된 첫번째 방법과 두번째 방법은 같은 방법이다.** 이제 $\tilde{\beta_2}=\hat{\beta_2}$임을 보이자. 즉 $\hat{\beta_2}$는 아래임을 보이자. 
\begin{align}
