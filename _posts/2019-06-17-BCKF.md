...
- 잘 알겠지만 $\hat\boldsymbol\beta_2$ 을 구하고 싶다면 $\hat\boldsymbol\beta$ 에서 두번째 원소를 취하면 된다. 강의노트에서는 $\boldsymbol\hat{\beta_2}$ 와 아래의 방법으로 구한 $\boldsymbol\tilde{\beta_2}$ 가 같음을 증명하였다. <br/><br/>
