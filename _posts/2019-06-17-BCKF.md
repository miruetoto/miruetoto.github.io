...
\begin{align}
\begin{bmatrix} \bf X_2'X_2 & X_2'X_1 \\\\ X_1'X_2 & X_1'X_1 \end{bmatrix} \begin{bmatrix} \hat{\beta_2} \\\\ \hat{\beta_1} \end{bmatrix} = \begin{bmatrix} X_2' y \\\\ X_1' y \end{bmatrix}
\end{align}
임을 상기하자. 위의 식의 양변에 $\bf{\begin{bmatrix} I & X_2'X_1(X_1'X_1)^{-1} \\\\ 0 & I \end{bmatrix}} $을 곱하자. 
\begin{align}
