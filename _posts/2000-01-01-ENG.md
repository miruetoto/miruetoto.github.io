...
__A와 B의 차이를 설명하면서 논의를 시작하겠습니다.__
...
__그런데 그 A가 사실은 (우리가 잘 아는) B같은 거거든요~__
...
__A는 ~에서 가장 널리 쓰이는 방법 중 하나이며, 그 적용분야는 ~~부터 ~~까지 다양하다.__ 
...
__사람들은 ~를 함으로써 자료에 대한 첫인상(?) 혹은 직관을 얻으려고 노력한다.__ 
- **People try to get a first impression on their data by**

__이것은 A와 비교하여 더 나은 해석을 제공한다.__
