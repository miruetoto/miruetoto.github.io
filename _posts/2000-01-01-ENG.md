...
### $\sharp$ present, show / be presented in, be shown in 
...
### $\sharp$ such that, in the respect that 
***~라는 점에서***
- in the respect that
...
***이것은 A와 비교하여 보면 더 나은 해석을 제공한다. ~ 관점에서.***
...
### $\sharp$ 각 케이스로 상황을 나누고 케이스별 상황설명 
...
### $\sharp$ notion, concept
***SSA에서 중요한 개념은(본질은) ~이다.*** 
...
### $\sharp$ 약어표현
***오더가 $p$인 autoregressive model, 줄여서 AR(p), 는***
...
### $\sharp$ 기타표현 
***~ 에서는,***
- For example, **in SSA** the eigenvectors produced by slowlyvarying series components are slowly-varyin. 
