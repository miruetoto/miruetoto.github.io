...
__~못지않게 중요하다. ~보다 덜 중요한것은 아니다.__
...
__~를 살펴보는 것은 흥미롭다.__
- It would be interesting to see that ~.

__$X$가 잘 정의되니까 $f$에 대응하는 $f^{\ast}$도 잘 정의된다. 따라서 $f$를 정의하는 것은 $f^{\ast}$를 정의하는 것과 같은 셈이다.__ 
- Thanks to the well defined $X$, for all $f$ there exists $f^{\ast}: {\cal V} \to \mathbb{R}$ such that $f^{\ast}:f\circ X^{-1}$. Therefore, defining $f$ on $V$ is the same as defining $f^{\ast}$ in ${\cal V}$.
