...
### $\star$ present, show / be presented in, be shown in 
...
***순전히 ~의 측면에서만 보면, ~라고 생각된다. 그러나, 구조를 좀더 자세히 보면 ~임을 알게된다.***
...
### $\star$ such that, in the respect that 
***~라는 점에서***
- in the respect that
...
- It retains a great similiarity between A and B. 
...
### $\star$ two regards, twofold manner
...
### $\star$ is one of the most widely used techniques
...
### $\star$ somewhat the likelihood, however,
