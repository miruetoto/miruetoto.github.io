...
라그랑지안을 아래와 같이 정의하자. 
\begin{align}
{\cal L}:= \\mathbb{E}_ {({\bf s}_ 1,{\bf a}_ 1) \sim \rho_{\pi} } r({\bf s}_ 1, {\bf a}_ 1)  -\alpha_1 \bigg( 
\mathbb{E}_ {({\bf s}_ 1,{\bf a}_ 1) \sim \rho_{\pi} } \big(-\log\pi_1 ({\bf a}_ 1 \| {\bf s}_ 1) \big) - {\cal H}
\bigg) 
\end{align}
...
이제 아래식을 연립하여 풀면 된다. 
\begin{align}
\alpha_1^* = \underset{\alpha_1}{\operatorname{argmin} } \mahtbb{E}  
\end{align}
