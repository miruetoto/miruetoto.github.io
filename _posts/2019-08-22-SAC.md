...
\begin{align}
\frac{1}{2}\Bigg(Q_{\pi,\theta} ({\bf s}_ t,{\bf a}_ t)- \bigg( r({\bf s}_ t,{\bf a}_ t) + \gamma \big[  Q_{\pi,\bar \theta}( {\bf s}_ {t+1}, {\bf a}_ {t+1} )-\alpha \log \pi_{\phi}( {\bf a}_ {t+1} \| {\bf s}_ {t+1}) \big]\bigg)\Bigg)^2.
\end{align}
