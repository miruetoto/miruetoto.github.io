...
& = - \mathbb{E}_ { {\bf a}_ t \sim \pi'} \Bigg[ \pi'({\bf a}_ t \| {\bf s}_ t) \log \Bigg(\frac{\exp\big( \frac{1}{\alpha}Q_{\pi_{old} } ({\bf s}_ t, {\bf a}_ t) \big)}{Z_{\pi_ {old} }({\bf s}_ t)} \Bigg)\Bigg] \\\\ 
& = \mathbb{E}_ { {\bf a}_ t \sim \pi'} \Bigg[ \Bigg] 
\end{align}
