...
\begin{align}
\max_{\pi_0} \bigg( \mathbb{E}_ {({\bf s}_ t,{\bf a}_ t) \sim \rho_{\pi} } r({\bf s}_ 0, {\bf a}_ 0) +\max_{\pi_1} \big( \mathbb{E}_ {({\bf s}_ t,{\bf a}_ t) \sim \rho_{\pi} } r({\bf s}_ 1, {\bf a}_ 1) \big) \bigg)
\end{align}
