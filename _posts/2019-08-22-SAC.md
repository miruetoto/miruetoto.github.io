...
아래식을 이용하면 
\begin{align}
r(s,a)=\sum_{r \in {\cal R}}r \sum_{s'\in {\cal S}}p(s',r \| s,a) = \sum_{s',r \in {\cal S}\times {\cal R}}p(s',r \| s,a) r 
\end{align}
큐펑션에 대한 벨만이퀘이션은 아래와 같이 된다. 
\begin{align}
q_{\pi}(s,a)=r(s,a)+ \sum_{s',a}p(s',r \| s,a)\big[\gamma v_{\pi}(s') \big] 
\end{align}
