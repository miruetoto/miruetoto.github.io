...
\end{align}
How to do it? Just average! Let's drop us in situation that we only have to decide $4$-th element of $\tilde{\mathbb Y}$, i.e., $\tilde{y}_ 4$. The $\tilde{y}_ 4$ is determinded by value of $\big({\bf Y}\big)_ {ij}$ where $(i,j) \in {\cal A}_ 4$. It is reasonable that 
\begin{align}
