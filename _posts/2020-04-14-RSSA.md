...
- The SSA-like algorithms decompose the given data ${\mathbb X}$ into a sum of different components: 
\begin{align}
...
\begin{align}
\tilde{y}_ 4 = \frac{1}{4}({\bf Y}_ {41}+{\bf Y}_ {32}+{\bf Y}_ {23}+{\bf Y}_ {14}). 
\end{align}
