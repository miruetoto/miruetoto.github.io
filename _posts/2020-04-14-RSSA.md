...
- Suppose that ${\mathbb X}=(x_1,\dots,x_{100})^T$. Choose the length of window as 5, i.e., $L=5$. Then ${\cal T}$ maps $\mathbb{R}^100$ to space of Hankel matrix $5\times 96$ such that 
\begin{align}
