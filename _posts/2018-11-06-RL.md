...
<figcaption> 폴리쉬-이터레이션-알고리즘: Sutton 교재 그림 4.3.  </figcaption>	
</center>	
</figure>
<figure>	
<center>	
<img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/RL/RL45.png?raw=true" height="80%" width="80%">
<figcaption> 벨류-이터레이션-알고리즘: Sutton 교재 그림 4.5. </figcaption>	
</center>	
</figure>
...
- 하지만 이런 규칙을 무시하고 인플레이스 연산을 해보면 어떨까? 이것이 바로 에이싱크러너스-다이내믹-프로그래밍(Asynchronous Dynamic Programming) 의 아이디어이다. 에이싱크러너스-다이내믹-프로그래밍 에서는 하나의 밸류펑션만 메모리에 저장하고 계속 그걸 업데이트 한다고 보면 된다. 
