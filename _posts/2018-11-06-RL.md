...
<center><img src="https://github.com/miruetoto/miruetoto.github.io/blob/master/img/RL/RL_fig1.png?raw=true" height="80%" width="80%"></center>

- **state**: $4\times 4$ 격자위에서 로봇이 움직이고 있으므로 로봇이 존재할 수 있는 all possible state 는 총 16개이다. 16개의 상태를 각각 $s_1,\dots,s_{16}$ 이라고 정의하고 이들의 집합을 ${\cal S}$라고 하자. 즉 ${\cal S}:=\\{s_1,\dots,s_{16}\\}$ 이다. 
