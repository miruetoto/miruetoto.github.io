...
- 보통 여기까지하면 설치가 끝난다. 그담에는 예를들어 (http://192.168.0.4:8787/) 와 같은 곳에 접속하면 Rstudio를 쓸 수 있다. 여기에서 192.168.0.4은 ifconfig쳐서 나오는 주소이다. 그런데 기본포트를 변경하고 싶을때가 있다. 이럴경우 아래를 실행한다. 
