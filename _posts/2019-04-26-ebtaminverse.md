...
\begin{align}
\underset{\\{p_1,\dots,p_{\ell}\\}}{\operatorname{argmin}} \sum_{i=1}^{\xi} \sum_{\ell=1}^{\xi}\frac{1}{\xi-1} \sum_{\ell=1}^{\xi}\left( \frac{x_i^{\ell,\xi}}{p_{\ell}}-\frac{1}{\xi} \sum_{\ell=1}^{\xi}\frac{x_{i}^{\ell,\xi}}{p_{\ell}} \right)^2 
\end{align}
