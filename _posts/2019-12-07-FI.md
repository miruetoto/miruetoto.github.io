...
\begin{align}
\frac{1}{n} \sum_{i=1}^{n} \log f(X_i; \theta) \quad 
\end{align}
따라서 다음과 같은 추측을 할 수 있다. 
\begin{align}
\frac{1}{n}\ \underset{\theta \in \Theta}{\operatorname{ argmax} }\sum_{i=1}^{n} \log f(X_i; \theta) \quad \overset{p}{\operatorname\rightarrow} } \quad \underset{\theta \in \Theta}{\operatorname{ argmax} } E \log f(X_1;\theta)
\end{align}