...
-  보통 autocorrelation function을 줄여서 **ACF**라고 한다. 

- **(예제)** 아래모델의 ACF를 계산하여 보자.
\begin{align}
...
이제 아래식이 성립함을 관찰하자. 
\begin{align}
cov(\Delta y_t,\Delta y_t)=\sigma^2+\frac{\sigma^2(1-\phi)^2}{1-\phi^2}=\frac{2\sigma^2}{1+\phi}
\end{align}

- AR모델의 ACF는 점점 줄어든다. 그외에 대충 아래와 같은 특징을 기억하면 된다. <br/><br/>
