...
\begin{align}
{\bf 0}=c({\bf x}+{\bf d}) \approx c({\bf x})+ \frac{d}{d{\bf x}} c({\bf x})^T {\bf d}
\end{align}
...
\frac{\partial}{\partial\lambda}c({\bf x}) ={\bf 0}
\end{cases}
\end{align}
