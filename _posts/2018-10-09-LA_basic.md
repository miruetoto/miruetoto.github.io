...
\begin{cases}
{\bf X}=[X_1, \dots, X_p] \\\\ 
{\bf X}'=\begin{pmatrix} X_1' \\\\ \dots \\\\ X_p' \end{pmatrix}.
\end{cases}
\end{align}
***case 2***: ${\bf X}$가 row-vector의 결합으로 표현된 경우 <br/>
\begin{align}
\begin{cases}
{\bf X}=\begin{pmatrix}{\bf x}_ 1 \\\\ \dots \\\\ {\bf x}_ n\end{pmatrix} \\\\ 
{\bf X}'=[{\bf x}_ 1', \dots, {\bf x}_ n'],
\end{cases}
\end{align}
...
\begin{align}
\begin{cases}
{\boldsymbol y}= rbind(a_1,\dots,a_n) = \begin{pmatrix} a_1 \\\\ \dots \\\\ a_n\end{pmatrix} \\\\ 
{\boldsymbol y}'= cbind(a_1',\dots,a_n')=[a_1,\dots,a_n].
\end{cases}
\end{align}
