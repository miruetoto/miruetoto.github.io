...
\begin{align}
{\bf X}=rbind({\bf x}_ 1,\dots,{\bf x}_ n)=\begin{pmatrix}{\bf x}_ 1 \\\\ \dots \\\\ {\bf x}_ n\end{pmatrix} \quad \Longrightarrow \quad 
{\bf X}'=cbind({\bf x}_ 1',\dots,{\bf x}_ n')=[{\bf x}_ 1', \dots, {\bf x}_ n'],
\end{align}
***case 3***: ${\bf X}$가 이인석교수님 스타일로 표현된 경우 <br/>
\begin{align}
{\bf X}=\left(x_{ij}\right) \quad \Longrightarrow \quad {\bf X}'=\left(x_{ji}\right).
\end{align}
