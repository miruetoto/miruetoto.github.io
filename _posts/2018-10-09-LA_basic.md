...
아래를 관찰하면 이 결과는 매우 상식적이다. 
\begin{align}
{\bf D}{\bf E}=\begin{bmatrix} \lambda_1 & 0 & 0  \\\\ 0 & \lambda_2 & 0  \\\\ 0 & 0 & \lambda_3 \end{bmatrix}\begin{pmatrix}\bf e_1 \\\\ \bf e_2 \\\\ \bf e_3 \end{pmatrix} =[C_1\lambda_1 ,C_2\lambda_2, C_3\lambda_3] 
\end{align}<br/>
