...
\begin{align}
{\bf A}{\bf B}=\begin{pmatrix}A[1,] \\\\ \dots \\\\ A[n,]\end{pmatrix}[B[,1]\dots,B[,q]] = \Big\\{ A[i,]B[,k] \Big\\}, 
\end{align}
...
\begin{align}
{\bf X}{\bf Y}=[X_ 1,\dots X_ p] \begin{pmatrix} {\bf b}_ 1 \\\\ \dots \\\\ {\bf b}_ p\end{pmatrix} = \sum_{j=1}^{p} {\boldsymbol a}_ j {\bf b}_ j.
\end{align}
<br/>
