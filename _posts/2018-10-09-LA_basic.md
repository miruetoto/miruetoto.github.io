...
\begin{align}
{\bf X}'{\bf X}= & \Big\\{X_ {j_1}'X_ {j_2} \Big\\}, \mbox {j_1}
\end{align}
...
**(3)** $\begin{pmatrixrbind(X_1',\dots,X_ p') {\bf X} = rbind(X_1'{\bf X},\dots,X_p' {\bf X})$ <br/>
**(4)** ${\bf X}' [X_1,\dots,X_p]=  [{\bf X}'X_1,\dots,{\bf X}'X_p]$ 
