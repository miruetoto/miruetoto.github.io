...
\frac{1}{\sigma\sqrt{2\pi}}\exp\left(-\frac{z_i-{\bf x}_ i {\boldsymbol\beta}}{2\sigma^2} \right)  & w_i=1 \\\\ 
\delta(z_i) & w_i=0
\end{cases}=\left(\frac{e^{-\lambda_1} \lambda_1^{z_i}}{z_i !} \right)^{w_i} \left(\frac{e^{-\lambda_2} \lambda_2^{z_i}}{z_i !} \right)^{1-w_i}$
\end{align}
