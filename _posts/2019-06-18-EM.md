...
\begin{align}
E& \left[\log L(\lambda_1,\lambda_2,p) \Bigg| {\bf z} \right] \\\\ 
...
&=E \left[ \sum_{i=1}^{n}\left( W_i\log\bigcirc +(1-W_i)\log\bigtriangleup \right)  \Bigg ~ ~ | ~ ~ {\bf Z=z}  \right]  \\\\ \\\\
&=E \left[ \sum_{i=1}^{n}\left( W_i\log\frac{\bigcirc}{\bigtriangleup}+\log\bigtriangleup \right) \Bigg ~ ~ | ~ ~ {\bf Z=z} \right] \\\\ \\\\
