...
\ck 따라서 우선 $E(Z_{t-5},\epsilon_{t-5})$를 구하면 좋겠다. 그런데 이 값은 $E(Z_{t},\epsilon_{t})$와 같고 이 값은 $\simga^2$이다. 
...
\ck 식 $(1)=(3)$ 의 양변에 $Z_t$를 곱하고 평균을 취하면 아래를 얻는다. 
\[
\gamma_0=\psi_0 E(Z_t\epsilon_t)
\]
...
\]
상수항을 비교하면 $\psi_0=1$ 임을 알 수 있다.  또한 $B$의 계수를 
