...
\ck $m_2=o_p(1)$ 이고 $m_1^2=o_p(\frac{1}{\sqrt{n}})$ 이다. $o_p(1)+o_p(\frac{1}{\sqrt{n}})=o_p(1)$ 임을 이용하면 
\[
\sqrt{m_2-m_1^2}+\sqrt{m_2}=o_p(1)
\]
이다. 

\ck $\frac{o_p(\frac{1}{\sqrt{n}})}{o_p(1)}=o_p(\frac{1}{\sqrt{n}})$ 가 성립하므로 
\[
