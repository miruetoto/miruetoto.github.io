...
% \usepackage[left=10px,right=10px,top=10px,bottom=10px,paperwidth=8in,paperheight=110in]{geometry}
...
\begin{document}
\chapter{Big $O_p$ and little $o_p$

\ck 

\dfn $\{X_n\}$: array of random variable, $\{a_n\}$: array of real number. 
\begin{align*}
& X_n=O_p(a_n), \quad as ~ n\to \infty \\ 
& \Longleftrightarrow X_n/a_n=O_p(1), \quad as ~ n\to \infty \\ 
& \Longleftrightarrow \sup_{n}P\{|X_n/a_n|>k\} \underset{k\to\infty}{\to} 0
\end{align*}
